  ...
  return (
    <aside className="hidden lg:block sticky top-6 self-start w-64 shrink-0">
      <div className="bg-white dark:bg-slate-900 border border-line dark:border-slate-800 rounded-lg p-4 shadow-card">
        <div className="text-[11px] uppercase font-bold tracking-widest text-ink-400 dark:text-slate-500 mb-3 px-2">
          Neste manual
        </div>
            ...
            return (
              <a
                ...
                className={`flex items-center gap-3 px-3 py-2 rounded-md text-sm transition-colors ${
                  isActive
                    ? 'bg-teal-600/10 dark:bg-[#38bdf8]/10 text-teal-600 dark:text-[#38bdf8] font-semibold'
                    : 'text-ink-700 dark:text-slate-400 hover:bg-navy-50 dark:hover:bg-slate-800/50 hover:text-ink-900 dark:hover:text-white'
                }`}
              >
                <span className={`text-[10px] font-mono tabular-nums ${isActive ? 'text-teal-600 dark:text-[#38bdf8]' : 'text-ink-400 dark:text-slate-600'}`}>

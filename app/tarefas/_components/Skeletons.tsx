...
export const SkeletonCard = () => (
  <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-md p-4 shadow-sm animate-pulse">
    ...
    <div className="flex justify-between items-center mt-4"><div className="flex gap-2"><div className="h-6 bg-slate-100 dark:bg-slate-800 rounded-md w-6"></div><div className="h-6 bg-slate-100 dark:bg-slate-800 rounded-md w-6"></div></div><div className="flex gap-1"><div className="h-6 bg-slate-100 dark:bg-slate-800 rounded-md w-6"></div><div className="h-6 bg-slate-200 dark:bg-slate-700 rounded-md w-16"></div></div></div>
  </div>
)
...
export const SkeletonBoard = ({ columns }: { columns: number }) => (
  <div className="flex gap-4 overflow-x-auto pb-4" style={{ gridTemplateColumns: `repeat(${columns}, minmax(300px, 1fr))` }}>
    {Array.from({ length: columns }).map((_, i) => (
      <div key={i} className="rounded-lg border flex-1 min-w-[320px] flex flex-col max-h-[75vh] bg-slate-50/50 dark:bg-slate-950/50 border-slate-200 dark:border-slate-800">
...
export const SkeletonCalendar = () => (
  <main className="bg-white dark:bg-slate-900 rounded-lg shadow-sm border border-slate-100 dark:border-slate-800 overflow-hidden animate-pulse">

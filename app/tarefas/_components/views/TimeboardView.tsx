  ...
  return (
    <div className="flex gap-4 overflow-x-auto pb-4">
      {timeOrder.map((b) => (
        <div
          key={b}
          className={`rounded-2xl border flex-1 min-w-[320px] flex flex-col max-h-[75vh] transition-colors ${b === 'Atrasadas' ? 'bg-[#b43a3d]/10 dark:bg-[#b43a3d]/20 border-[#b43a3d]/20 dark:border-[#b43a3d]/30' : 'bg-slate-100/50 dark:bg-slate-900/50 border-slate-200 dark:border-slate-800'}`}
        >

...
const CORES_BG = [
  ...
  'from-slate-100 to-slate-50 dark:from-slate-700/30 dark:to-slate-700/10 border-slate-200 dark:border-slate-600',
...
export function Podio({ colaboradores }: { colaboradores: ColaboradorRow[] }) {
  ...
  return (
    <div className="mb-6">
      <h3 className="text-sm font-bold text-[#063955] dark:text-white uppercase tracking-wider mb-3 flex items-center gap-2">
        ...
        {top3.map((c, idx) => {
          ...
          return (
            ...
            >
              ...
              <div className="font-bold text-[#063955] dark:text-white text-lg leading-tight">{c.nome}</div>
              {c.email && (
              ...
              <div className="mt-4 flex items-end justify-between">
                ...
                <div className="text-right text-xs text-slate-600 dark:text-slate-300">
                  ...
                  <div className="text-slate-400 mt-0.5">{c.metrics.diasUteisAtivos}/{c.metrics.diasUteisPeriodo} dias ativos</div>
                </div>
              </div>
            </div>
          )
